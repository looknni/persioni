...
make distclean
make menuconfig # dnsmasq-full libustream-openssl wpad-openssl vim aircrack-ng openssl-util hcxdumptool tcpdump openssh-server openssh-sftp-server openssh-client unbound-daemon chrony
