...
---
##### [Ventoy](https://www.ventoy.net/en/index.html) . [Tracker.deb](https://tracker.debian.org/pkg/linux) . [Cppreference](https://cppreference.com/) . [Firefox](https://ftp.mozilla.org/pub/fenix/)
---
...
make distclean
make menuconfig # dnsmasq-full libustream-openssl wpad-openssl vim aircrack-ng openssl-util hcxdumptool tcpdump openssh-server openssh-sftp-server openssh-client unbound-daemon chrony unbound-control unbound-control-setup unbound-host unbound-checkconf unbound-anchor
...
if ls .config/google-chrome/Default/.com.google.Chrome.* > /dev/null 2>&1;then
        rm ~/.config/google-chrome/Default/.com.google.Chrome.*
fi
```
