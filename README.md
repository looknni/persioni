...
>> - /biosboot ~($\lim_{31k\rightarrow\infty}1M$).../boot/efi ~(1M+$\sum_{6n}^M$System+40M).../boot ~(300M+$\sum_{100n}^M$Kernel).../ ~($\frac{\infty}{0.29}$).../swap ~($\sqrt[i=2]{RAM}$) . /home  ~($\frac{\infty}{0.69}$).. /usr . /var . /opt . /tmp
