...
make menuconfig # dnsmasq-full libustream-wolfssl wpad-wolfssl openssl-util vim aircrack-ng openssl-util hcxdumptool tcpdump openssh-server openssh-sftp-server openssh-client
make -j4 V=s
```
